<template>
  ...
  export default {
    ...
    methods: {
      ...
      getCoupons() {
        const vm = this;
        const url = `${process.env.APIPATH}/api/${process.env.CUSTOMERPATH}/admin/coupons`;
      ...
      updateCoupon() {
        const vm = this;
        if (vm.isNew) {
          const url = `${process.env.APIPATH}/api/${process.env.CUSTOMERPATH}/admin/coupon`;
          ...
          const url = `${process.env.APIPATH}/api/${process.env.CUSTOMERPATH}/admin/coupon/${vm.tempCoupon.id}`;
